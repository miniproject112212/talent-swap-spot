...
export default function Footer() {
  ...
  return (
    <footer className="bg-skillswap-navy text-white py-12 mt-16">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo and about */}
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              <div className="bg-white text-skillswap-teal p-2 rounded-md">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/messages" className="text-gray-300 hover:text-white text-sm">
                  Messages
                </Link>
              </li>
              <li>
